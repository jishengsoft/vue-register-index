    ...
    <Modal
        ...
        <Form ref="formItem" :label-width="80" :model="formItem" :rules="ruleValidate">
            <FormItem label="公司名称" prop="Company">
                <Input v-model="formItem.Company" placeholder="请输入..." readonly></Input>
            </FormItem>
            ...
            <FormItem label="版本" prop="version">
                <Select v-model="formItem.version" placeholder="请选择版本" :disabled='isTrue'>
...
export default {
  data() {
    return {
      ...
      border: true,
      isTrue: Cookies.get("access") == "2" ? true : false,
      formItem: {
        Company: "",
        User: "",
        uuid: "",
  ...
  methods: {
    ...
    clear() {
      ...
      this.formItem.uuid = "";
      if (Cookies.get("access") == "2") {
        this.formItem.Company = this.companyList[0].company;
      } else {
        this.formItem.Company = "";
      }
      this.formItem.remark = "";
      if (Cookies.get("access") == "2") {
        this.formItem.version = this.companyList[0].version;
      } else {
