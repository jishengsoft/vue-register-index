  ...
  <Card>
    <Form>
        ...
        <FormItem label="加密狗号" prop="dogNumber" :label-width="160">
            ...
            <input type="hidden" v-model="dogNumber1" >
        </FormItem>
            ...
            */
            getCode(){
                ...
                util.ajax.get('getDecode.asp?registerCode='+this.requestCode).then(function(response){
                    ...
                    _this.dogNumber = msg.dogCode.substr(0,5);
                    _this.dogNumber1 = msg.dogCode;
            ...
            getRegisterCode(){
                ...
                if(this.client.length > 25){
                    _this.$Message.info('客户太长');
                    return;
                }
                let postData = {
                    ...
                    dogCode:this.dogNumber1,
                    newversion:this.newversion

                }
                util.ajax.post('getRegisterMoney.asp',qs.stringify(postData)).then(function(response){
                    let msg = response.data;
                    if (msg.state == 3)
					{
                        ...
                        type: 'warning'
                            ...
                            util.ajax.post('getRegisterCode.asp',qs.stringify(postData1)).then(function(response){
