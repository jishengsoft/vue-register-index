...
<div style="padding:20px;background:#fff;margin:10px">
    <Form ref="formInline" inline label-position="right" :label-width="80">
        <FormItem label="客户名称" prop="searchCompany">
        <Input v-model="searchCompany" style="width:120px" clearable>
    ...
    export default {
        ...
        methods:{
            getAgentList(){
                ...
                util.ajax.get('getTrialQuery.asp?rows='+pageSize+'&page='+currentPage+'&client='+searchCompany+
